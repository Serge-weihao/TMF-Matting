...
def main():
    ...
    cfg.gpus = args.gpus
    cfg.checkpoint_config['least_iter'] =args.ckpt_least
    cfg.checkpoint_config['interval'] =args.ckpt_interval
    cfg.evaluation['least_iter']  =args.eval_least
    cfg.evaluation['interval']  =args.eval_interval
    cfg.log_config['interval']  =args.log_interval
    cfg.total_iters = args.total_iters
    cfg.data['samples_per_gpu']=args.per_gpu
    cfg.data['workers_per_gpu']=args.per_gpu
    if args.bn_momentum is not None:
        cfg.model.backbone.encoder['bn_mo']=args.bn_momentum
    if args.lr is not None:
        cfg.optimizers['lr'] = args.lr
    ...
    print('para: ',params_count(model)/(1024*1024))
