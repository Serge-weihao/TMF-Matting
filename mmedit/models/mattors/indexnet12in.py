...
class IndexNet12in(BaseMattor):
    ...
    def __init__(self,
        ...
        super(IndexNet12in, self).__init__(backbone, None, train_cfg, test_cfg,
                                       pretrained)
    ...
    def forward_train(self, merged, trimap, meta, alpha, ori_merged, fg, bg,trimap_transformed):
        ...
        """
        #print((merged, trimap))
        pred_alpha = self.backbone(torch.cat((merged,trimap_transformed, trimap), 1))
