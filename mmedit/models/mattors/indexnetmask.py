...
class IndexNetMask(BaseMattor):
    ...
    def __init__(self,
                 ...
                 loss_comp=None,
                 gloss_comp=None):
        super(IndexNetMask, self).__init__(backbone, None, train_cfg, test_cfg,
                                       pretrained)
    ...
    def forward_train(self, merged, trimap, meta, alpha, ori_merged, fg, bg,mask):
