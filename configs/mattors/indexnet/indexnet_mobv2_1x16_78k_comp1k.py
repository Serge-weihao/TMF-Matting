...
train_pipeline = [
    ...
    dict(type='RandomLoadResizeBg', bg_dir=bg_dir),#dict(type='LoadImageFromFile', key='bg'),
    dict(type='MergeFgAndBg', save_original_img=True),#dict(type='LoadImageFromFile', key='merged', save_original_img=True),
